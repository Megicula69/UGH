...
public class OrderPage extends javax.swing.JFrame {
    ...
    public OrderPage(DefaultListModel<String> listModel) { // Step 2: Constructor to receive listModel
    ...
    private void ChickensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChickensActionPerformed
        ...
        this.dispose(); // Hide the current window
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        String item = "Pork Bicol Express";
    ...
    public static void main(String args[]) {
            ...
            public void run() {
                new OrderPage(new DefaultListModel<>()).setVisible(true);
            }
        });
    }
